...
const AboutClient = () => {
  ...
  useEffect(() => {
    ...
    fetch("/AnimationDeveloper.json")
      ...
      .catch((error) =>
        console.error("Error loading developer animation:", error)
      );
  }, []);
  ...
  function getPositionDescription(role) {
    const descriptions = {
      "Software Instructor":
        "Teaching web development technologies and mentoring students in software engineering projects.",
      "Workforce Manager":
        "Managing team schedules, forecasting, and optimizing resource allocation for operational efficiency.",
      "Web Developer":
        "Developing and maintaining web applications using React, Node.js, and other modern technologies.",
      "Resource Planner":
        "Analyzing staffing needs, creating schedules, and optimizing workforce deployment.",
      "Analytics Specialist":
        "Analyzing operational data to identify trends and provide insights for business improvement.",
      "Real-Time Analyst":
        "Monitoring real-time metrics, making adjustments to staffing, and ensuring service level compliance.",
    };
  ...
  const experienceItems = t("about.experience.positions", {
    returnObjects: true,
  }).map((position) => ({
    ...position,
    ...
    : [
        {
          ...
          period: "2020 - 2022",
          description:
            "Comprehensive training in modern web development technologies including React, Node.js, Next.js and database management.",
        },
        {
          title: "Baccalaureate in Management",
          period: "2015 - 2018",
          description:
            "Focused on business management principles, economics, and organizational behavior.",
        },
      ];
  ...
  return (
    <Container maxWidth="xl" className="py-10">
      ...
      >
        ...
        {developerAnimation && (
          <Box
            sx={{ maxWidth: "750px", mx: "auto", mb: 6, position: "relative" }}
          >
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
